package com.tsystems.javaschool.view.util;
...
public class GlobalExceptionHandler {
    ...
    @RequestMapping(value = "/WEB-INF/views/error.jsp")
    public ModelAndView handle400(Model model) {

        System.out.println("handle400!!!");
        ModelAndView modelAndView = new ModelAndView("/error.jsp");
        modelAndView.addObject("errorCode", "400");
        modelAndView.addObject("error", "Error 400 happens");
